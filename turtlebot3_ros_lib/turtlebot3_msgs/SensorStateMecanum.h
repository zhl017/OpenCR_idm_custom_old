#ifndef _ROS_turtlebot3_msgs_SensorStateMecanum_h
#define _ROS_turtlebot3_msgs_SensorStateMecanum_h
...
namespace turtlebot3_msgs
{
  ...
  class SensorStateMecanum : public ros::Msg
  {
    public:
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 3) = (u_right_encoder.base >> (8 * 3)) & 0xFF;
      ...
      u_rear_left_encoder.real = this->rear_left_encoder;
      *(outbuffer + offset + 0) = (u_rear_left_encoder.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_rear_left_encoder.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_rear_left_encoder.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_rear_left_encoder.base >> (8 * 3)) & 0xFF;
      offset += sizeof(this->rear_left_encoder);
      union {
        int32_t real;
        uint32_t base;
      } u_rear_right_encoder;
      u_rear_right_encoder.real = this->rear_right_encoder;
      *(outbuffer + offset + 0) = (u_rear_right_encoder.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_rear_right_encoder.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_rear_right_encoder.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_rear_right_encoder.base >> (8 * 3)) & 0xFF;
      offset += sizeof(this->rear_right_encoder);
      union {
        float real;
        uint32_t base;
      } u_battery;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_rear_left_encoder.base = 0;
      u_rear_left_encoder.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_rear_left_encoder.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_rear_left_encoder.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_rear_left_encoder.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->rear_left_encoder = u_rear_left_encoder.real;
      offset += sizeof(this->rear_left_encoder);
      union {
        int32_t real;
        uint32_t base;
      } u_rear_right_encoder;
      u_rear_right_encoder.base = 0;
      u_rear_right_encoder.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_rear_right_encoder.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_rear_right_encoder.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_rear_right_encoder.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->rear_right_encoder = u_rear_right_encoder.real;
      offset += sizeof(this->rear_right_encoder);
      union {
        float real;
        uint32_t base;
    ...
    const char * getType(){ return "turtlebot3_msgs/SensorStateMecanum"; };
    const char * getMD5(){ return "ff079ce73eeaeceed866ae3c3bea78bb"; };

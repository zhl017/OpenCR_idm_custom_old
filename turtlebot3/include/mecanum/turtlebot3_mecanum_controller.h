...
#ifndef TURTLEBOT3_MECANUM_CONTROLLER_H_
#define TURTLEBOT3_MECANUM_CONTROLLER_H_
...
class Turtlebot3MecanumController
{
 public:
  Turtlebot3MecanumController();
  ~Turtlebot3MecanumController();
...
#endif // TURTLEBOT3_MECANUM_CONTROLLER_H_